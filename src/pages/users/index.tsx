...
import { exportUsers, importUsers } from './actions';
...
const UserSection = (props: any) => {
    ...
    const deleteUsers = async () => {
        ...
        const allData: any = await deleteAPIFunction(DELETE_USERS,  {ids:myArray})
        if (allData.status) {
            props.apiMessage("Success")
        ...
        <>
            ...
            <div className="page-content">
                ...
                <UserLayout
                    ...
                    section="USER"
                    import={props.importUsers}
                    export={props.exportUsers}
                />
                {
                    overlay
                        ?
...
const mapDispatchToProps = { apiLoading, apiMessage, apiErrorMessage, importUsers, exportUsers };
